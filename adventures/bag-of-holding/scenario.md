...
Adapted from a one-page role playing adventure by Sam Seer, originally
submitted to the 2023 One Page Dungeon Competition and licensed under
...
Inside is a key! It's very large, but can be dragged with great
effort.
...
If the player jumps down from the axe head or upper axe handle, they
...
Korbar the Dwarf's adventuring party stuck her in this Bag of Holding
during a stealth mission, then forgot about her.  She knows how the
Bag works.  She is wearing heavy iron armor, but is unarmed (the axe
actually belongs to her).  She knows the key is in the secret
compartment, but won't offer the secret unless she likes the player.
She is very afraid of spiders, especially the big one that's been
stalking her, which she will never willingly agree to fight.

### Spider

If the player walks through the spider's webs, it attacks.  During
combat, if the player is bare-handed, it kills the player (game over).
